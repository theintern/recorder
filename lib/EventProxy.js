(typeof define === 'function' && define.amd ? define : /* istanbul ignore next */ function (factory) {
	...
	EventProxy.prototype = {
		...
		connect: function () {
			...
			this._port = this.chrome.runtime.connect(this.chrome.runtime.id, { name: 'eventProxy' });
			this._port.onDisconnect.addListener(function disconnect() {
				self._port.onDisconnect.removeListener(disconnect);
				EVENT_TYPES.forEach(function (eventType) {
